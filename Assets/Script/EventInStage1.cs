...
public class EventInStage1 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.name == "Portal12")
        {
            ...
            player.PlayerReposition(new Vector2(0.8f, -10.2f));
        }
        ...
        if (collision.gameObject.name == "Portal21")
        {
            ...
            player.PlayerReposition(new Vector2(15.1f, -10.2f));
        }
        ...
        if (collision.gameObject.name == "Portal321")
        {
            ...
            Scene2.SetActive(true);
            player.PlayerReposition(new Vector2(9.5f, -10.2f));
        }
        ...
        if (collision.gameObject.name == "Portal322")
        {
            ...
            Scene2.SetActive(true);
            player.PlayerReposition(new Vector2(12.8f, -6.2f));
        }
        ...
        if (collision.gameObject.name == "Portal323")
        {
            ...
            Scene2.SetActive(true);
            player.PlayerReposition(new Vector2(4.9f, -6.2f));
        }
        ...
        if (collision.gameObject.name == "Portal24")
        {
            ...
            player.PlayerReposition(new Vector2(2.0f, -10f));
        }
        ...
        if (collision.gameObject.name == "Portal42")
        {
            ...
            Scene2.SetActive(true);
            player.PlayerReposition(new Vector2(-0.2f, -3.2f));
        }
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        if (collision.gameObject.name == "교실문 (1)" && Input.GetKeyDown(KeyCode.W))
        {
            ...
            player.PlayerReposition(new Vector2(2.2f, -10.0f));
        }
